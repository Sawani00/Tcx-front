    ...
    <div className="flex justify-center align-center w-screen">
        <div className="flex flex-col align-center justify-center w-[60%] mx-[10%]">
            ...
            <div className="grid grid-cols-2 grid-rows-3 gap-7">
                ...
                <LabelInputpen type="number" label="Phone number" placeholder="phone number"/>
                <LabelInputpen typpe="text" label="Adress" placeholder="your adress"/>
            </div>
            {/* <LabeledInput type="text" label="Description" placeholder="Description" className="w-[100px] bg-red-500"/> */}
            <label htmlFor="description" className="block text-sm font-medium text-gray-700 text-theblue font-[Gilroy] font-bold">Description</label>
