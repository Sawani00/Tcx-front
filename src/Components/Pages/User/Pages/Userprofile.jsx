    ...
    <div className="flex justify-center align-center w-screen">
        <div className="flex flex-col align-center justify-center w-[60%] mx-[10%]">
            ...
            <div className="grid grid-cols-2 grid-rows-3 gap-12 ">
                <Labelpen type="text" placeholder="First Name" label="First Name"/>
                <Labelpen type="text" placeholder="Last Name" label="Last Name"/>
                <Labelpen type="email" placeholder="Mail" label="Mail"/>
                <Labelpen type="number" placeholder="Phone Number" label="Phone Number"/>
                <Labelpen type="text" placeholder="Specialization" label="Specialization"/>
                <Labelpen type="password" placeholder="Password" label="Password"/>
            </div>
